...
public class JdbcVisitRepositoryImpl implements VisitRepository {
    ...
    protected MapSqlParameterSource createVisitParameterSource(Visit visit) {
        return new MapSqlParameterSource()
            ...
            .addValue("cancelled", visit.getCancelled())
    ...
    public Collection<Visit> findAll() throws DataAccessException {
        ...
        return this.namedParameterJdbcTemplate.query(
            "SELECT visits.id as visit_id, pets.id as pets_id, visit_date, description, visits.cancelled, visits.cancellation_reason FROM visits LEFT JOIN pets ON visits.pet_id = pets.id",
